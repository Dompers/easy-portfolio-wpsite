                    ...
                    <div class="text_part">
                        ...
                        <div class="right">
                            ...
                            <div class="bottom_digits_parts">
                                <?php if (get_field('acf_info-projects')) : ?><div><b id="myTargetElement"><?php the_field('acf_info-projects'); ?></b> <span>REALISIERTE PROJEKTE</span></div><?php endif; ?>
                                <?php if (get_field('acf_info-years')) : ?><div>0<b id="myTargetElement_2"><?php the_field('acf_info-years'); ?></b> <span>JAHREN AUF DER MARKT</span></div><?php endif; ?>
                            </div>
                        </div>
                    </div>
                </div>
