...
// Pano2VR 5.0/12111
// Filename: simplex_v5_autohide_panoramma02.ggsk
// Generated Di Mai 7 10:44:29 2019

function pano2vrSkin(player,base) {
	var ggSkinVars = [];
	ggSkinVars['kontroller'] = false;
	var me=this;
	var flag=false;
	var nodeMarker=[];
	...
	this.addSkin=function() {
		...
		this._button_image_fullscreen.ggLeft=-87;
		...
		this._controller_show.ggUpdateConditionTimer=function () {
			...
			if (me._controller_show.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._controller_show.ggCurrentLogicStateScaling == 0) {
					me._controller_show.style[domTransition]=cssPrefix + 'transform none,' + cssPrefix + 'transform none';
